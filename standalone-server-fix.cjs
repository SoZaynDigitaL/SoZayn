...
// Check if this is a CommonJS environment and fix any module system conflicts
if (typeof require === 'undefined') {
  console.error('This script must be run in a CommonJS environment');
  // Try to detect if we're in an ES module environment and potentially fix it
  console.error('Detected ES module environment. Please rename this file to standalone-server-fix.cjs');
  console.error('Or set package.json without "type": "module"');
  process.exit(1);
}
